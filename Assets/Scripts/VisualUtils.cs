...
//namespace BossRoom.Visual
    ...
    public static class VisualUtils
    {
        ...
        public static void SmoothMove(Transform moveTransform, Transform targetTransform, float timeDelta, ref float closingSpeed, float maxAngularSpeed,float minSmoothSpeed,float targetCatchupTime)
        {
            ...
            if (posDiffMag > 0)
            {
                closingSpeed = Mathf.Max(closingSpeed, Mathf.Max(minSmoothSpeed, posDiffMag / targetCatchupTime));
