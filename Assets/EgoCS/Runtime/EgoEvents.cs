...
public static class EgoEvents
{
	...
	static List<Type> egoEvents= new List<Type>();
	...
	static void MakeEventInit( Type eventType )
	{
	...
	static void MakeEventClear(Type eventType)
	{
        var fullEventType = typeof(EgoEvents<>).MakeGenericType(eventType);
        fullEventType.GetMethod("Clear", System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.NonPublic).Invoke(null, null);
    }
