...
public class EgoComponent : MonoBehaviour
{
    ...
    public bool HasComponents(System.Type type)
    {
        return mask[ComponentIDs.Get(type)];
    }
    ...
    public bool TryGetComponents(System.Type type,out Component component1)
    {
        if (HasComponents(type))
        {
            component1 = GetComponent(type);
